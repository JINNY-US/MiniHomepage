...
<?php
	...
	if ($mode=="send")
		$sql = "select * from message where send_id='$userid' order by num desc limit 10";
	else
		$sql = "select * from message where rv_id='$userid' order by num desc limit 10";
